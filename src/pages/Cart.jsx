...
//                         <td>
//                           <button onClick={()=>dispatchEvent(removeCartItem(product?.id))}><i className="fa-solid fa-trash text-red-600"></i></button>
//                         </td>
//                       </tr>
//                       ))
//                      }
...
//                     <button className='bg-red-600 text-white rounded p-3 me-3'>EMPTY CART</button>
...
//                     <hr />
//                     <button className='w-full bg-green-500 rounded p-5 text-white font-bold mt-5'>checkout</button>
//                   </div>
//                 </div>
//               </div>
//             </>
